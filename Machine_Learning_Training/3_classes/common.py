...
def data_loader(base_path, training_model, data_type, feature_selection = False, num_features=15, k_bow=8):
    ...
    if data_type =="Z":
        ...
        if feature_selection:
            ...
            train_X3, test_X3 = feature_selection_SelectKBest_CHI2_BoW(train_dataset['XE'], train_Y, test_dataset['XE'], k_bow=k_bow)
        ...
        if feature_selection:
            train_X, test_X = feature_selection_SelectKBest_CHI2_BoW(train_dataset['XE'], train_Y, test_dataset['XE'],k_bow=k_bow)
        else:
