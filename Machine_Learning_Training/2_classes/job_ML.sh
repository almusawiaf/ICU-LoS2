...
models=("ml_LR.py" "ml_RF.py" "ml_XGBoost.py" "ml_SVM.py") 
...
smote_ing="no"
pca_ing="no"
saving_path="${normalization}/log_sci_sm_2000_F_${num_days}/${num_features}_features_KBoW_200"
...
export base_path="../../../Data/XY_BoW/${normalization}/2_classes"
export training_model="BoW_sci_sm_2000_F_${num_days}"
